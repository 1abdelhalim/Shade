...
const OVERLAY_ID = "shade-web-overlay-root";
const STYLE_ID = "shade-web-style";
const BOX_SIMILARITY_THRESHOLD = 0.015;
const domSensitiveNodes = new Set();
...
function isBoxSimilar(a, b) {
  return (
    Math.abs(a.x1 - b.x1) < BOX_SIMILARITY_THRESHOLD &&
    Math.abs(a.y1 - b.y1) < BOX_SIMILARITY_THRESHOLD &&
    Math.abs(a.x2 - b.x2) < BOX_SIMILARITY_THRESHOLD &&
    Math.abs(a.y2 - b.y2) < BOX_SIMILARITY_THRESHOLD
  );
}
